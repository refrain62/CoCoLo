...
describe('年度繰り上げ', () => {
  it('activeのstudentだけを一度だけ+1する計画を作る', () => {
    expect(
      planPromotion([
        ...
        { id: 'suspended', category: 'student', gradeLevel: 9, status: 'suspended' },
        { id: 'retired', category: 'student', gradeLevel: 9, status: 'retired' },
        { id: 'adult', category: 'adult', gradeLevel: null, status: 'active' },
        { id: 'unset', category: 'student', gradeLevel: null, status: 'active' },
      ]),
    ).toEqual({
      previewCount: 1,
  ...
  it('DB上限を超える学年を安全に拒否する', () => {
    expect(() =>
      planPromotion([
        { id: 'overflow', category: 'student', gradeLevel: 99, status: 'active' },
      ]),
