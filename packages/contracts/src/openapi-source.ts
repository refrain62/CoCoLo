...
export const openapiDocument = {
  ...
  paths: {
    ...
    '/global-announcements': {
      get: {
        operationId: 'listGlobalAnnouncements',
        summary: '認証済み利用者向けの公開済み全体お知らせを取得',
        parameters: [
          {
            name: 'X-CoCoLo-Team-Id',
            in: 'header',
            required: false,
            schema: { type: 'string', format: 'uuid' },
            description: '複数チーム所属時に表示対象とするチーム',
          },
        ],
        responses: {
          200: {
            description: '公開済み全体お知らせ一覧',
            content: {
              'application/json': {
                schema: {
                  $ref: '#/components/schemas/GlobalAnnouncementListResponse',
                },
              },
            },
          },
    ...
    '/system/context': {
      get: {
        ...
        summary: 'システム管理者コンテキストを取得',
        responses: {
          200: {
            description: 'システム管理者コンテキスト',
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/SystemContextResponse' },
              },
            },
          },
          401: { $ref: '#/components/responses/Unauthorized' },
    ...
    '/system/announcements': {
      get: {
        operationId: 'listSystemAnnouncements',
        summary: '全体お知らせを管理者向けに取得',
        responses: {
          200: {
            description: '全体お知らせ一覧',
            content: {
              'application/json': {
                schema: {
                  $ref: '#/components/schemas/SystemAnnouncementListResponse',
                },
              },
            },
          },
      ...
      post: {
        ...
        requestBody: {
          ...
          content: {
            'application/json': {
              schema: {
                $ref: '#/components/schemas/SystemAnnouncementCreateInput',
              },
            },
          },
        },
    ...
    '/system/announcements/{announcementId}': {
      patch: {
        operationId: 'updateSystemAnnouncement',
        summary: '全体お知らせを更新',
        parameters: [
          {
            name: 'announcementId',
        ...
        requestBody: {
          ...
          content: {
            'application/json': {
              schema: {
                $ref: '#/components/schemas/SystemAnnouncementUpdateInput',
              },
            },
          },
        },
    ...
    '/system/features': {
      get: {
        operationId: 'listSystemFeatures',
        summary: 'システム全体の機能提供状態を取得',
        responses: {
          200: {
            description: '機能提供状態一覧',
            content: {
              'application/json': {
                schema: {
                  $ref: '#/components/schemas/SystemFeatureListResponse',
                },
              },
            },
          },
    ...
    '/system/features/{featureKey}': {
      patch: {
        operationId: 'updateSystemFeature',
        summary: '有償機能のシステム全体提供状態を更新',
        parameters: [
          {
            name: 'featureKey',
            in: 'path',
        ...
        requestBody: {
          ...
          content: {
            'application/json': {
              schema: {
                $ref: '#/components/schemas/SystemFeatureUpdateInput',
              },
            },
          },
        },
        responses: {
          200: {
            description: '機能提供状態を更新',
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/SystemFeatureResponse' },
              },
            },
          },
          400: { $ref: '#/components/responses/BadRequest' },
    ...
    '/ride-profile/display-name': {
      patch: {
        operationId: 'updateRideDisplayName',
        summary: '配車表に表示する自分の名前を更新',
        requestBody: {
          required: true,
          content: {
            'application/json': {
              schema: {
                $ref: '#/components/schemas/RideDisplayNameUpdateInput',
              },
            },
          },
        },
        responses: {
          200: {
            description: '更新後の配車表示名',
            content: {
              'application/json': {
                schema: {
                  $ref: '#/components/schemas/RideDisplayNameResponseEnvelope',
                },
              },
            },
          },
  ...
  components: {
    ...
    schemas: {
      ...
      RideDisplayNameResponseEnvelope: {
        type: 'object',
        required: ['data'],
        additionalProperties: false,
        properties: {
      ...
      SystemContextResponse: {
        ...
        properties: {
          data: {
            ...
            additionalProperties: false,
            properties: {
              systemAdmin: { type: 'boolean', const: true },
            },
          },
        },
      },
      SystemAnnouncementListResponse: {
        ...
        properties: {
          data: {
            type: 'array',
            maxItems: 500,
            items: { $ref: '#/components/schemas/SystemAnnouncementItem' },
          },
        },
      },
      SystemAnnouncementResponse: {
        ...
        additionalProperties: false,
        properties: {
          data: { $ref: '#/components/schemas/SystemAnnouncementItem' },
        },
      },
      ...
      SystemFeatureListResponse: {
        ...
        properties: {
          data: {
            type: 'array',
            maxItems: 100,
            items: { $ref: '#/components/schemas/SystemFeatureItem' },
          },
        },
      },
      SystemFeatureResponse: {
        ...
        additionalProperties: false,
        properties: {
          data: { $ref: '#/components/schemas/SystemFeatureItem' },
        },
      },
      SystemFeatureItem: {
        type: 'object',
        required: ['key', 'billingType', 'displayName', 'systemEnabled'],
        additionalProperties: false,
        properties: {
          key: { type: 'string', pattern: '^[a-z][a-z0-9._-]{1,63}$' },
          billingType: { type: 'string', enum: ['free', 'paid'] },
          displayName: { type: 'string', minLength: 1, maxLength: 200 },
          systemEnabled: { type: 'boolean' },
        },
      },
      SystemFeatureUpdateInput: {
        type: 'object',
      ...
      GlobalAnnouncementListResponse: {
        type: 'object',
        required: ['data'],
        additionalProperties: false,
        properties: {
          data: {
            type: 'array',
            maxItems: 500,
            items: { $ref: '#/components/schemas/GlobalAnnouncementItem' },
          },
        },
      },
