    ...
    <>
      ...
      <article className="manual-content">
        ...
        <section id="register" aria-labelledby="register-heading">
          ...
          <p>
            部員登録は、オーナーまたは管理者（owner /
            admin）だけが実行できます。部員一覧の「部員を登録」を押して入力欄を開きます。
          </p>
          <ol>
            <li>氏名を入力します。</li>
        ...
        <section id="promotion" aria-labelledby="promotion-heading">
          ...
          <p>
            年度繰り上げは、オーナーまたは管理者（owner /
            admin）向けの操作です。年度末など、チームで実行時期と対象年度を確認してから行ってください。
          </p>
          <ol>
          ...
          <p>
            一般、停止、退部、学年未設定の部員は対象外です。学年を一律に1つ上げ、繰り上げ後の学年が17以上の場合は「OB
